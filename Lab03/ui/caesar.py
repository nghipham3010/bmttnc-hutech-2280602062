...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(290, 0, 221, 61))
        font = QtGui.QFont()
        ...
        self.btn_ecrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_ecrypt.setGeometry(QtCore.QRect(180, 340, 91, 41))
        self.btn_ecrypt.setObjectName("btn_ecrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(380, 340, 91, 41))
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.txt_plain_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_plain_text.setGeometry(QtCore.QRect(100, 90, 441, 71))
        self.txt_plain_text.setObjectName("txt_plain_text")
        self.txt_key = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_key.setGeometry(QtCore.QRect(100, 180, 451, 51))
        self.txt_key.setObjectName("txt_key")
        self.txt_cipher_text = QtWidgets.QTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(90, 250, 461, 71))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_ecrypt.setText(_translate("MainWindow", "Encrypt"))
